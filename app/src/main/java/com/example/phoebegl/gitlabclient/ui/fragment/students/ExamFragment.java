...
public class ExamFragment extends BaseMainFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position, View view, RecyclerView.ViewHolder vh) {
                EventBus.getDefault().post(new StartBrotherEvent(SExaminfoFragment.newInstance(adapter.getExam(position))));
            }
        });
    ...
    public void initData() {
        CourseService.getInstance().getExams(MyApp.getCourseId())
